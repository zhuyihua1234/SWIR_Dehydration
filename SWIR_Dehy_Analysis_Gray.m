...
% Load TIFF Picture
picpath = '/Users/nai-yuannicholaschang/Documents/FRIED LAB/Nick AIM2/Aim2 Visible Pictures/';
picture = imread([picpath ext(1:end-1) '.tif']);
tiff = picture(:,:,1:3);
...
subplot(1,2,2);
imshow(tiff, []);
title([strrep(ext,'_',' ') 'TIFF Image'], 'FontSize', fontSize);
...
% savepath = uigetdir;
savepath = '/Users/nai-yuannicholaschang/Documents/FRIED LAB/Nick AIM2/AIM2 Dehy Results/SWIR Dehy Results';
